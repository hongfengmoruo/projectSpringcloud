...
public interface UsersRepository extends JpaRepository<Users, Integer>,JpaSpecificationExecutor<Users>{
	 ...
	 */
	@Query("select new com.springcloud.entity.Users(u.userId,u.userName,u.userNumber,u.userPassword,u.userSex,u.userPhone,u.userSite,u.userBirthday,u.userEmail,u.userPhoto,u.jdictionId,u.userStatus) from Users u where u.userId=:userId and u.userPassword=:userPassword and u.jdictionId=:jdictionId and u.userStatus=0")
	 ...
	 */
	@Modifying
	@Query("update Users u set u.userNumber=:#{#users.userNumber},u.userSex=:#{#users.userSex},u.userBirthday=:#{#users.userBirthday},u.userEmail=:#{#users.userEmail},u.userSite=:#{#users.userSite} where u.userId=:#{#users.userId} ")
	public abstract Integer update(@Param("users") Users users);
	
	/**
	 * 修改USERS表中指定的USER_ID的用户头像
	 * @param users		修改的用户信息
	 * @return			成功返回大于0的整数，否则返回小于等于0的整数
	 */
	@Modifying
